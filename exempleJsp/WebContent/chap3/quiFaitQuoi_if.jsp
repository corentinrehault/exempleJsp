...
<form action="quiFaitQuoi_if.jsp" method="POST">
	...
	<br>
	<p>
		<input type="Radio" name="valeur" value="0"> Jean-Jacques
		Beinex <br> <br> <input type="Radio" name="valeur" value="1">
		Luc Besson <br> <br> <input type="Radio" name="valeur"
			value="2"> Jean-Jacques Annaud <br> <br> <input
			type="Radio" name="valeur" value="3"> Jean-Pierre Jeunet <br>
